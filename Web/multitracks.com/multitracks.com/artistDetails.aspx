...
<head>
	...
	<body class="premium standard u-fix-fancybox-iframe">
		<form>
			...
			<div class="wrapper mod-standard mod-gray" id="tabs">
				<div class="details-banner">
					<div class="details-banner--overlay"></div>
					<div class="details-banner--hero">
						<img src="" runat="server" id="artistHeroImage" class="details-banner--hero--img" 
						 alt="Bethel Music">
					</div>
					<div class="details-banner--info">
						<a href="#" class="details-banner--info--box">
								<img src="" runat="server" id="artistImageUrl" class="details-banner--hero--img" 
						 alt="Bethel Music">
						</a>
				...
				<nav class="discovery--nav">
					<ul class="discovery--nav--list tab-filter--list u-no-scrollbar">
						<li class="discovery--nav--list--item tab-filter--item is-active">
							<a class="tab-filter" href="#tabs-1">Overview</a>
						</li>
						<li class="discovery--nav--list--item tab-filter--item">
							<a class="tab-filter" href="#tabs-2">Songs</a>
						</li>
						<li class="discovery--nav--list--item tab-filter--item">
							<a class="tab-filter" href="#tabs-3">Albums</a>
						</li>
					</ul> <!-- /.browse-header-filters -->
				</nav>

				<div class="discovery--container u-container" >
							<main class="discovery--section" id="tabs-1">

								<section class="standard--holder" id="">
									...
									<ul runat="server" id="playlist" class="song-list mod-new mod-menu">
										<asp:Repeater runat="server" ID="songItems">
											...
											<div class="song-list--item--player-img media-player">
												...
												src="<%#Eval("Album_imageURL") %>" alt="Way Maker">
											</div>

											<div class="song-list--item--right">

												<a href="#" class="song-list--item--primary"><%#Eval("Song_Title") %></a>
												<a class="song-list--item--secondary"><%#Eval("Song_Title") %></a>
								...
								<div class="discovery--space-saver">
									<section class="standard--holder">
										...
										<div class="discovery--grid-holder">
											...
											<div class="ly-grid ly-grid-cranberries" runat="server" id="items2">
												<asp:Repeater runat="server" ID="repeaterItems">
													<ItemTemplate>
														<div class="media-item">
															<a class="media-item--img--link" href="#" tabindex="0">
																<img class="media-item--img" alt="<%#Eval("Album_Title") %>" src="<%#Eval("Album_imageURL") %>" >
																<span class="image-tag">Master</span>
															</a>
															<a class="media-item--title" href="#" tabindex="0"><%#Eval("Album_Title") %></a>
															<a class="media-item--subtitle" href="#" tabindex="0"><%#Eval("Artist_Title") %></a>
														</div>
													</ItemTemplate>
												</asp:Repeater>
